...
# Como tem o while, se não tivesse esse esc alinhado com o else, ele iria ficar só dentro da primeira opção que selecionar no while, por exemplo, se selecionasse 2, só ficaria no 2 e não sairia mais. O esc permite uma nova escolha